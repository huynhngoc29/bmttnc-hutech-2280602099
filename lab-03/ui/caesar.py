...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(240, 30, 291, 51))
        font = QtGui.QFont()
        ...
        self.label_2.setGeometry(QtCore.QRect(70, 80, 101, 51))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.label_3.setGeometry(QtCore.QRect(70, 210, 101, 51))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        ...
        self.label_4.setGeometry(QtCore.QRect(60, 310, 101, 51))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        ...
        self.btn_encrypt.setGeometry(QtCore.QRect(210, 450, 93, 28))
        self.btn_encrypt.setObjectName("btn_encrypt")
        self.btn_decrypt = QtWidgets.QPushButton(self.centralwidget)
        self.btn_decrypt.setGeometry(QtCore.QRect(440, 450, 93, 28))
        self.btn_decrypt.setObjectName("btn_decrypt")
        self.txt_plain_text = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.txt_plain_text.setGeometry(QtCore.QRect(150, 100, 551, 87))
        self.txt_plain_text.setObjectName("txt_plain_text")
        self.txt_key = QtWidgets.QLineEdit(self.centralwidget)
        self.txt_key.setGeometry(QtCore.QRect(150, 230, 551, 22))
        self.txt_key.setObjectName("txt_key")
        self.txt_cipher_text = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.txt_cipher_text.setGeometry(QtCore.QRect(150, 330, 551, 87))
