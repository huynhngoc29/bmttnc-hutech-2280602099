...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(300, -10, 221, 121))
        font = QtGui.QFont()
        ...
        self.label_2.setGeometry(QtCore.QRect(30, 130, 101, 41))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.label_3.setGeometry(QtCore.QRect(460, 270, 101, 41))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
        ...
        self.label_4.setGeometry(QtCore.QRect(460, 130, 101, 41))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
        ...
        self.label_5.setGeometry(QtCore.QRect(30, 260, 101, 41))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
        ...
        self.btn_decrypt.setGeometry(QtCore.QRect(310, 410, 81, 51))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.btn_sign.setGeometry(QtCore.QRect(580, 420, 81, 51))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.btn_gen_keys.setGeometry(QtCore.QRect(550, 30, 131, 51))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.btn_verify.setGeometry(QtCore.QRect(780, 420, 81, 51))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        font.setBold(True)
